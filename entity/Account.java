package com.equabli.datascrubbing.entity;
...
public class Account implements Serializable {
	...
	@Formula(value = "(select mcp.partner_type from conf.map_clientpartner mcp join conf.partner pr on mcp.partner_id = pr.partner_id where mcp.client_id = client_id and pr.partner_id = partner_id and pr.record_status_id = conf.df_record_status('"+ConfRecordStatus.ENABLED+"') and mcp.record_status_id = conf.df_record_status('"+ConfRecordStatus.ENABLED+"'))")
	...
	@ManyToOne(fetch = FetchType.EAGER)
	@JoinFormula(value = "(select prd.product_id from conf.product prd where prd.product_id = product_id and prd.record_status_id = conf.df_record_status('"+ConfRecordStatus.ENABLED+"') )")
	private Product product;

	@Column(name = "productsubtype_id")
	private Integer productSubTypeId;

	@Formula(value = "(select count(prd.productsubtype_id) from conf.productsubtype prd where prd.product_id = product_id and prd.subproduct_id = productsubtype_id and prd.record_status_id = conf.df_record_status('"+ConfRecordStatus.ENABLED+"') )")
	...
	@ManyToOne(fetch = FetchType.EAGER)
	@JoinFormula(value = "(select lu.lookup_id from conf.lookup lu inner join conf.lookup_group lug on lu.lookup_group_id = lug.lookup_group_id where lug.keyvalue = 'customer_type' and lu.keycode = customer_type and lu.record_status_id = conf.df_record_status('"+ConfRecordStatus.ENABLED+"') )")
	...
	@ManyToOne(fetch = FetchType.EAGER)
	@JoinFormula(value = "(select lu.lookup_id from conf.lookup lu inner join conf.lookup_group lug on lu.lookup_group_id = lug.lookup_group_id where lug.keyvalue = 'debt_type' and lu.keycode = debt_type and lu.record_status_id = conf.df_record_status('"+ConfRecordStatus.ENABLED+"') )")
	...
	@ManyToOne(fetch = FetchType.EAGER)
	@JoinFormula(value = "(select lu.lookup_id from conf.lookup lu inner join conf.lookup_group lug on lu.lookup_group_id = lug.lookup_group_id where lug.keyvalue = 'portfolio_code' and lu.keycode = portfolio_code and lu.record_status_id = conf.df_record_status('"+ConfRecordStatus.ENABLED+"') )")
	...
	@ManyToOne(fetch = FetchType.EAGER)
	@JoinFormula(value = "(select lu.lookup_id from conf.lookup lu inner join conf.lookup_group lug on lu.lookup_group_id = lug.lookup_group_id where lug.keyvalue = 'account_application_type' and lu.keycode = original_account_application_type and lu.record_status_id = conf.df_record_status('"+ConfRecordStatus.ENABLED+"') )")
	...
	@ManyToOne(fetch = FetchType.EAGER)
	@JoinFormula(value = "(select lu.lookup_id from conf.lookup lu inner join conf.lookup_group lug on lu.lookup_group_id = lug.lookup_group_id where lug.keyvalue = 'sale_review_status' and lu.keycode = sale_review_status and lu.record_status_id = conf.df_record_status('"+ConfRecordStatus.ENABLED+"') )")
	...
	public Account(Long accountId, Double amtOtherfeeCurrentbalance, Double amtInterestCurrentbalance, Double amtPrincipalCurrentbalance, Double amtCurrentbalance) {
	...
	public Account(Long accountId, Double amtOtherfeeCurrentbalance, Double amtInterestCurrentbalance, Double amtPrincipalCurrentbalance, Double amtCurrentbalance, LocalDate chargeOffDate, 
			Double amtPreChargeOffPrinciple, Double amtPreChargeOffInterest, Double amtPreChargeOffFees, Double amtLatefeeCurrentbalance, Double amtCourtcostCurrentbalance, Double amtAttorneyfeeCurrentbalance, 
			Double amtPreChargeOffBalance, Double amtPostChargeOffInterest, Double amtPostChargeOffFee, Double amtPostChargeOffPayment, Double amtPostChargeOffCredit) {
		this.accountId = accountId;
		this.amtCurrentbalance = amtCurrentbalance;
		this.amtPrincipalCurrentbalance = amtPrincipalCurrentbalance;
		this.amtInterestCurrentbalance = amtInterestCurrentbalance;
	...
	public Account(Long accountId, Integer clientId, Integer partnerId, String partnerType, String clientAccountNumber, String originalAccountNumber, String currentLenderCreditor,
				   String originalLenderCreditor, Integer productId, Integer productSubTypeId, Integer productSubTypeCount, Integer clientJobScheduleId, LocalDate originalAccountOpenDate,
				   LocalDate assignedDate, LocalDate delinquencyDate, LocalDate chargeOffDate, LocalDate lastPaymentDate, LocalDate lastPurchaseDate, LocalDate lastCashAdvanceDate,
				   LocalDate lastBalanceTransferDate, LocalDate solDate, LocalDate clientSolDate, LocalDate equabliSolDate,
				   String customerType, String debtType, String portfolioCode, String originalAccountApplicationType, Double amtLastPayment, Double amtLastPurchase, Double amtLastCashAdvance,
				   Double amtLastBalanceTransfer, Double amtPreChargeOffBalance, Double amtPreChargeOffPrinciple, Double amtPreChargeOffInterest, Double amtPreChargeOffFees, Double amtPostChargeOffInterest,
				   Double pctPostChargeOffInterest, Double amtPostChargeOffFee, Double pctPostChargeOffFee, Double amtPostChargeOffPayment, Double amtPostChargeOffCredit, Double amtAssigned, Double amtPrincipalAssigned,
				   Double amtInterestAssigned, Double amtLatefeeAssigned, Double amtOtherfeeAssigned, Double amtCourtcostAssigned, Double amtAttorneyfeeAssigned, String productAffinity,
				   LocalDate currentbalanceDate, Double amtCurrentbalance, Double amtPrincipalCurrentbalance, Double amtInterestCurrentbalance, Double amtLatefeeCurrentbalance,
				   Double amtOtherfeeCurrentbalance, Double amtCourtcostCurrentbalance, Double amtAttorneyfeeCurrentbalance, String saleReviewStatus, LocalDate partnerAssignmentDate) {
		this.accountId = accountId;
	...
	public LookUp getPortfolioCodeLookup() { return portfolioCodeLookup; }
	...
	public void setPortfolioCodeLookup(LookUp portfolioCodeLookup) { this.portfolioCodeLookup = portfolioCodeLookup; }
    ...
    public Account(Integer clientId, String clientAccountNumber, String currentLenderCreditor, String firstName, String middleName, String lastName, String identificationNumber, Double amtPreChargeOffBalance) {
        this.clientId = clientId;
        this.clientAccountNumber = clientAccountNumber;
        this.currentLenderCreditor = currentLenderCreditor;
        this.amtPreChargeOffBalance = amtPreChargeOffBalance;
    ...
    public Account(String originalAccountNumber, Integer clientId, String originalLenderCreditor, String firstName, String middleName, String lastName, String identificationNumber, Double amtPreChargeOffBalance) {
        this.originalAccountNumber = originalAccountNumber;
        this.clientId = clientId;
        this.originalLenderCreditor = originalLenderCreditor;
        this.amtPreChargeOffBalance = amtPreChargeOffBalance;
    ...
    public Account(Long accountId, String clientName, String clientAccountNumber, String originalAccountNumber, String shortName, String description) {
    	this.accountId = accountId;
    ...
    public Account(Long accountId, Double amtPrincipalCurrentbalance, Double amtInterestCurrentbalance, Double amtOtherfeeCurrentbalance) {
    	this.accountId = accountId;
    	this.amtPrincipalCurrentbalance = amtPrincipalCurrentbalance;
    	this.amtInterestCurrentbalance = amtInterestCurrentbalance;
    	this.amtOtherfeeCurrentbalance = amtOtherfeeCurrentbalance;
	...
	public void setPreChargeOffBuckets(Account account) {
		...
		if(account.getClient().getShortName().equals(CommonConstants.CLIENT_MARLETTE_LOANPRO_SHORT_NAME)) {
			Double sum  =  (CommonUtils.isDoubleNull(account.getAmtLatefeeAssigned()) ? 0.00 : account.getAmtLatefeeAssigned()) 
			...
			account.setAmtPreChargeOffFees(CommonUtils.isDoubleNull(account.getAmtLatefeeAssigned()) ? 0.00 : account.getAmtLatefeeAssigned());
		}
	}
